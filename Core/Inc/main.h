...
/* Private defines -----------------------------------------------------------*/
#define C_MOTOR_FI_Pin GPIO_PIN_5
#define C_MOTOR_FI_GPIO_Port GPIOE
#define C_MOTOR_BI_Pin GPIO_PIN_6
#define C_MOTOR_BI_GPIO_Port GPIOE
#define A_ENCODER_3_Pin GPIO_PIN_0
#define A_ENCODER_3_GPIO_Port GPIOA
#define A_ENCODER_4_Pin GPIO_PIN_1
#define A_ENCODER_4_GPIO_Port GPIOA
...
#define A_MOTOR_BI_Pin GPIO_PIN_13
#define A_MOTOR_BI_GPIO_Port GPIOE
#define A_MOTOR_FI_Pin GPIO_PIN_14
...
#define JETSON_USART1_TX_Pin GPIO_PIN_9
#define JETSON_USART1_TX_GPIO_Port GPIOA
#define JETSON_USART1_RX_Pin GPIO_PIN_10
#define JETSON_USART1_RX_GPIO_Port GPIOA
#define B_ENCODER_3_Pin GPIO_PIN_15
#define B_ENCODER_3_GPIO_Port GPIOA
#define B_ENCODER_4_Pin GPIO_PIN_3
#define B_ENCODER_4_GPIO_Port GPIOB
...
#define C_ENCODER_3_Pin GPIO_PIN_6
#define C_ENCODER_3_GPIO_Port GPIOB
#define C_ENCODER_4_Pin GPIO_PIN_7
